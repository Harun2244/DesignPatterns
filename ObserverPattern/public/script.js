...
const qualityControlText = document.querySelector('#qualityControlText');
const salesDepartmentText = document.querySelector('#salesDepartmentText');
const orderStatus = document.querySelector('select');
let order = new Orders;
let qualityControl = new QualityControl(order);
let salesDepartment = new SalesDepartment(order);
